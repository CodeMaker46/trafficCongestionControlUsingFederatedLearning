...
def print_usage_instructions():
    ...
    print("   python client.py --client-id client_1 --sumo-config sumo_configs/intersection.sumocfg")
    print("   # Terminal 3 (Client 2):")
    print("   python client.py --client-id client_2 --sumo-config sumo_configs/intersection.sumocfg")
